...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { available: @equipment.available, code_name: @equipment.code_name, device_name: @equipment.device_name }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { available: @equipment.available, code_name: @equipment.code_name, device_name: @equipment.device_name }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
